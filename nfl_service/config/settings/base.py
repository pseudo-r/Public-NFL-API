"""Base settings for nfl_service project.
...
SPECTACULAR_SETTINGS = {
    "TITLE": "nfl Service API",
    "DESCRIPTION": "Production-ready REST API for nfl sports data ingestion and querying",
    "VERSION": "1.0.0",
    ...
    "TAGS": [
        ...
        {"name": "Ingest", "description": "nfl data ingestion endpoints"},
...
nfl_CLIENT = {
    ...
    "MAX_RETRIES": env.int("nfl_MAX_RETRIES", default=3),
    "RETRY_BACKOFF": env.float("nfl_RETRY_BACKOFF", default=1.0),
    "USER_AGENT": env(
        "nfl_USER_AGENT",
        default="nfl-Service/1.0 (https://github.com/nfl-service)",
    ),
    "RATE_LIMIT_REQUESTS": env.int("nfl_RATE_LIMIT_REQUESTS", default=60),
    "RATE_LIMIT_PERIOD": env.int("nfl_RATE_LIMIT_PERIOD", default=60),
}
