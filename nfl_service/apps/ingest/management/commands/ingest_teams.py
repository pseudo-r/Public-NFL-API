"""Management command to ingest teams from nfl."""
...
class Command(BaseCommand):
    """Django management command to ingest teams from nfl."""

    help = "Ingest team data from nfl for a given sport and league"
