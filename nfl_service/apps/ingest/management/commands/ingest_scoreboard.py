"""Management command to ingest scoreboard data from nfl."""
...
class Command(BaseCommand):
    """Django management command to ingest scoreboard data from nfl."""

    help = "Ingest scoreboard/event data from nfl for a given sport, league, and date"
