"""Database models for nfl sports data."""
...
class Venue(TimestampMixin):
    ...
    nfl_id = models.CharField(max_length=50, unique=True, db_index=True)
...
class Team(TimestampMixin):
    ...
    nfl_id = models.CharField(max_length=50, db_index=True)
...
class NewsArticle(TimestampMixin):
    """News article from nfl news or Now API."""

    nfl_id = models.CharField(max_length=100, unique=True, db_index=True)
...
class Injury(TimestampMixin):
    ...
    nfl_id = models.CharField(max_length=100, blank=True, db_index=True)
    athlete_nfl_id = models.CharField(max_length=50, blank=True, db_index=True)
...
class AthleteSeasonStats(TimestampMixin):
    ...
    athlete_nfl_id = models.CharField(max_length=50, db_index=True)
    athlete_name = models.CharField(max_length=100, blank=True)
