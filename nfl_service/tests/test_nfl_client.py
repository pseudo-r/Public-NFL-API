...
from clients.nfl_client import nflClient, nflEndpointDomain


class TestnflClient:
    """Tests for nflClient class."""
    ...
    def test_handle_404_response(self, httpx_mock: HTTPXMock):
        ...
        with nflClient() as client, pytest.raises(nflNotFoundError):
    ...
    def test_handle_429_response(self, httpx_mock: HTTPXMock):
        ...
        with nflClient() as client, pytest.raises(nflRateLimitError):
    ...
    def test_handle_500_response_with_retry(self, httpx_mock: HTTPXMock):
        ...
        with nflClient() as client, pytest.raises(nflClientError):
            client.get_scoreboard("basketball", "nba")
...
class TestnflClientRetry:
    """Tests for nfl client retry behavior."""
...
# ---------------------------------------------------------------------------
# Domain routing — new domains added to nflEndpointDomain
# ---------------------------------------------------------------------------
