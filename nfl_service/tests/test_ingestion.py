...
class TestScoreboardIngestionService:
    ...
    def test_ingest_scoreboard_success(self, mock_scoreboard_response):
        ...
        Team.objects.create(
            league=league, nfl_id="1", abbreviation="ATL", display_name="Atlanta Hawks"
        )
        Team.objects.create(
            league=league, nfl_id="2", abbreviation="BOS", display_name="Boston Celtics"
        )
        ...
        event = Event.objects.get(nfl_id="401584666")
