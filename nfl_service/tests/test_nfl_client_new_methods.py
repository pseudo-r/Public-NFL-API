"""Tests for new nfl client methods added during March 2026 audit."""
...
class TestGameSituationEndpoints:
    ...
    def test_get_game_predictor(self, httpx_mock: HTTPXMock):
        """Test nfl game predictor endpoint."""
        mock_response = {
            "header": "nfl BPI Win Probability",
    ...
    def test_get_game_broadcasts(self, httpx_mock: HTTPXMock):
        ...
        assert response.is_success
        assert response.data["items"][0]["media"]["shortName"] == "nfl"
